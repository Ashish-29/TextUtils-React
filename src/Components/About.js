...
export default function About() {
    ...
    const [btnkey,setbtnkey] = useState('Enable Dark Mode')
  ...
  return (
    <div className='container my-5' style={mode}>
        ...
        <button className="btn btn-success my-2" onClick={togglemode}>{btnkey}</button>
    </div>
  )
}
